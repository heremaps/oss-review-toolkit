...
interface DependencyNode {
     ...
     * dependency graph. Refer to the class comment for further information. This base implementation returns the
     * same instance assuming that this object is directly mapped to an underlying data structure.
     */
    @JsonIgnore
